...
class Renderer {
  ...
  constructor(canvas, opts) {
    this.canvas = canvas;
    const { source: source, uniforms: uniforms } = opts;
    ...
    const uniformSetter = (name, type) => {
      ...
      switch (type) {
        ...
        case "bool":
          return (value) => gl.uniform1f(location, value ? 1 : 0);
        case "int":
        ...
        case "uint":
          return (value) => gl.uniform1ui(location, value);
        case "uvec2":
          return (value) => gl.uniform2uiv(location, value);
        case "uvec3":
          return (value) => gl.uniform3uiv(location, value);
        case "uvec4":
          return (value) => gl.uniform4uiv(location, value);
        default:
          throw new Error("unknown uniform type", { cause: type });
      }
    };
...
function Bauble(canvas, opts) {
  ...
  switch (dimensions) {
    ...
    default:
      throw new Error("unknown dimension", { cause: dimensions });
  }
  draw();
  return {
    draw: draw,
